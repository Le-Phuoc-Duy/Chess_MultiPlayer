...
//
//            //Them friend vao user
//            user1.getFriends().add(friend12);
//            user1.getFriends().add(friend13);
//            user2.getFriends().add(friend21);
//            user3.getFriends().add(friend31);
//            user3.getFriends().add(friend34);
//            user4.getFriends().add(friend43);
//
